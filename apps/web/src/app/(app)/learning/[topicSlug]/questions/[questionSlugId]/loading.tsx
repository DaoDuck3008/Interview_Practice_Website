...
export default function LoadingLearningQuestionDetail() {
  return (
    <main
      className="mx-auto flex w-full max-w-6xl flex-col gap-4 px-4 py-5 md:px-6 md:py-7 lg:grid lg:grid-cols-[minmax(0,1fr)_340px] lg:items-start"
      aria-label="Đang tải chi tiết câu hỏi"
      aria-busy="true"
    >
      ...
      <article className="min-w-0 overflow-hidden rounded-[30px] border border-white/[0.13] bg-[#10162d]/95">
        <div className="border-b border-white/[0.08] px-4 py-5 sm:px-6">
          ...
          <Skeleton className="mt-5 h-9 w-11/12 rounded-2xl" />
          <Skeleton className="mt-3 h-9 w-3/4 rounded-2xl" />
