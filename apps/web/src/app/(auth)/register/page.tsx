...
function RegisterContent() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      if (status === 409) {
        setError("Email này đã được sử dụng. Hãy thử đăng nhập.");
      } else {
      ...
      >
        ...
        <div className="w-full max-w-sm flex flex-col gap-8 relative z-10">
          ...
          <div className="flex flex-col gap-2">
            <h1 className="text-2xl font-bold text-[#f4f4f6]">Tạo tài khoản</h1>
            <p className="text-sm text-[#606072]">
              Bắt đầu luyện tập phỏng vấn ngay hôm nay
            </p>
          </div>
